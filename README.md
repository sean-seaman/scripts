Just a collection of some of my scripts. I keep these in a directory added to my 'Path' environment variable so I can run them anywhere from the commandline.
